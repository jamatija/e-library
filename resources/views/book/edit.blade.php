...
<div class="heading">
            ...
            <div class="flex flex-row ml-[30px]">
                <div class="w-[50%]">
                    <div class="mt-[20px]">
                        ...
                        <input type="text" name="title" value="{{ $book->title }}" id="nazivKnjiga"
                    ...
                    <div class="mt-[20px]">
                        ...
                        <textarea name="description" value="{{ $book->description }}" class="flex w-[90%] mt-2 px-2 py-2 text-base bg-white border border-gray-300 shadow-sm appearance-none focus:outline-none focus:ring-2 focus:ring-[#576cdf]"></textarea>
                        
                    </div>

                    <div class="mt-[20px]">
                        <p>Izaberite kategorije <span class="text-red-500">*</span></p>
                        <select x-cloak id="kategorija" multiple>
                ...
                <div class="mt-[20px]">
                    ...
                    <select x-cloak id="zanr"multiple>
                ...
                <div id="validateZanr"></div>
                    ...
                    <div >
                        ...
                        <input type="text" value="{{ $book->page_count }}" name="page_count" id="brStrana" class="flex w-[45%] mt-2 px-2 py-2 text-base bg-white border border-gray-300 shadow-sm appearance-none focus:outline-none focus:ring-2 focus:ring-[#576cdf]" onkeydown="clearErrorsBrStrana()"/>
                        <div id="validateBrStrana"></div>
                    </div>

                    <div class="mt-[20px]">
                        <p>Pismo <span class="text-red-500">*</span></p>
                        <select class="flex w-[45%] mt-2 px-2 py-2 border bg-white border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-[#576cdf]" name="script" id="pismo" onclick="clearErrorsPismo()">
                            <option disabled selected></option>
                            @foreach($scripts as $scr)
                                <option value="{{ $scr->id }}">{{ $scr->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="mt-[20px]">
                        ...
                        <select class="flex w-[45%] mt-2 px-2 py-2 border bg-white border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-[#576cdf]" name="binding" id="povez" onclick="clearErrorsPovez()">
                            ...
                            @foreach($bindings as $bind)
                                <option value="{{ $bind->id }}">{{ $bind->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="mt-[20px]">
                        ...
                        <select class="flex w-[45%] mt-2 px-2 py-2 border bg-white border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-[#576cdf]" name="size" id="format" onclick="clearErrorsFormat()">
                            <option disabled selected></option>
    ...
    <div class="w-[50%]">
        ...
        <div class="mt-[20px]">
            ...
            <select
                class="flex w-[45%] mt-2 px-2 py-2 border bg-white border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-[#576cdf]"
                name="publish_date" id="godinaIzdavanja" onclick="clearErrorsGodinaIzdavanja()">
                <option disabled selected></option>
        ...
        <div class="mt-[20px]">
            ...
            <input type="text" name="total_count" id="knjigaKolicina"
