<div class="heading">
                <div class="flex flex-row justify-between border-b-[1px] border-[#e4dfdf]">
                        ...
                        <div>
                            <nav class="w-full rounded">
                                <ol class="flex list-reset">
                                    ...
                                    <li>
                                        <a  class="text-[#2196f3] hover:text-blue-600">
                                            ID-354
                                        </a>
                                    </li>
                                </ol>
                    ...
                    <div class="pt-[24px] pr-[30px]">
                        ...
                        <a href="{{ route($resourcePlural.'.edit', $user->id) }}" class="hover:text-blue-600 inline ml-[20px] pr-[10px]">
                        ...
                        <div class="z-10 hidden transition-all duration-300 origin-top-right transform scale-95 -translate-y-2 dropdown-student-profile">
                            <div class="absolute right-0 w-56 mt-[10px] origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none" aria-labelledby="headlessui-menu-button-1" id="headlessui-menu-items-117" role="menu">
                                <div class="py-1">
                                   <form action="{{ route($resourcePlural.'.destroy', $user->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                        <button type="submit" tabindex="0" class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600" role="menuitem">
        ...
        <div class="flex flex-row">
            <div class="mr-[30px]">
                ...
                <div class="mt-[40px]">
                    ...
                    <a href="#" class="block font-medium text-[#2196f3]">{{ $user->email }}</a>
                </div>
                <div class="mt-[40px]">
            ...
            <div class="ml-[100px]  mt-[20px]">
                <img class="p-2 border-2 border-gray-300" width="300px" src="{{ asset('/storage/'.$user->picture) }}" alt="profile image">
            </div>
        </div>
    </div>
